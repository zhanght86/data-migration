...
public class UserBaseExtendDo {
    ...
    public String getOtherEstate() {
        return otherEstate;
    }

    public void setOtherEstate(String otherEstate) {
    ...
    public void setEstateDesc(String estateDesc) {
        this.estateDesc = estateDesc == null ? null : estateDesc.trim();
    }
    ...
    public String getLocalHousehold() {
        return localHousehold;
    }

    public void setLocalHousehold(String localHousehold) {
        this.localHousehold = localHousehold == null ? null : localHousehold.trim();
    }

    public Integer getAlipayCert() {
        return alipayCert;
    }
    ...
    public void setMonthSpend(String monthSpend) {
        this.monthSpend = monthSpend == null ? null : monthSpend.trim();
    }
    ...
    public void setRoadAddr(String roadAddr) {
        this.roadAddr = roadAddr == null ? null : roadAddr.trim();
    }
    ...
    public void setPayOffForm(String payOffForm) {
        this.payOffForm = payOffForm == null ? null : payOffForm.trim();
    }
